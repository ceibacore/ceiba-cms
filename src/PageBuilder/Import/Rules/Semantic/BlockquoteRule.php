...
/**
 * Maps blockquote, address, and time elements.
 * Preserves attributes and adds pb-semantic-{tag} class prefix.
 */
final class BlockquoteRule implements RuleInterface
{
    private const SUPPORTED_TAGS = ['blockquote', 'address', 'time'];
